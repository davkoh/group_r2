data {
  ...
  vector<lower=0,upper=1>[G] cons; // concentration vector of the Dirichlet prior for all covariates
  vector<lower=0,upper=1>[p] cons_g; // concentration vector of the Dirichlet prior by group
